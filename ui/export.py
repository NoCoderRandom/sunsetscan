...
class ReportExporter:
    ...
    Backward-compatible with existing sunsetscan.py calls.
    ...
    def _build_executive_summary(self, counts: dict, scan_result, risk_scores,
        ...
        overview = (
            f"SunsetScan scanned {hosts_up} active device(s) on {scan_result.target} "
...
<title>SunsetScan Report — {scan_result.target}</title>{css}</head><body>
<div class="container">
<header><h1>SunsetScan Security Report</h1><p>{scan_result.target}</p></header>
<div class="meta">
  <span><b>{now}</b>Generated</span>
  <span><b>{scan_result.profile}</b>Profile</span>
  <span><b>{scan_result.duration:.1f}s</b>Duration</span>
  <span><b>v{self.settings.version}</b>SunsetScan</span>
</div>
<div class="summary">
...
<footer>Generated by SunsetScan v{self.settings.version} | {now} | This report is for authorised use only.</footer>
</div></body></html>"""
        return html
