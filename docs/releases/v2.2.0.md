...
|---|---|---|
| Debian, Ubuntu, Raspberry Pi OS, Linux Mint, Pop!_OS | `sunsetscan_2.2.0-1_all.deb` and matching `.sha256` | Verify the checksum, then run `sudo apt install ./sunsetscan_2.2.0-1_all.deb`. |
...
**Licensing:** application code is MIT licensed. The hardware lifecycle database has a separate [CC BY-NC 4.0 license](../../data/hardware_eol/LICENSE.md).
